...
if ($user !== "") {
    ...
    $checkBookQuery = "SELECT id_libro FROM LIBROS WHERE nombre = ? AND id_usuario = (SELECT id_usuario FROM USUARIOS WHERE usuario = ?)";
    ...
    if ($stmtCheckBook->num_rows > 0) {
        ...
        if ($stmtBook->affected_rows > 0) {
            ...
            if ($stmtCollection->affected_rows > 0) {
                ...
                /*
                if ($stmtBookCollection->affected_rows > 0) {
                    $result .= "Book linked to collection successfully. ";
                } else {
                    $result .= "Error linking book to collection. ";
                }*/
